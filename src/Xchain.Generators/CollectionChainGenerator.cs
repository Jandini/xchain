...
public sealed class CollectionChainGenerator : IIncrementalGenerator
{
    ...
    {
        var chainClasses = context.SyntaxProvider
        ...
        context.RegisterSourceOutput(chainClasses, static (ctx, info) =>
        {
    ...
    private static (string HintName, string Source) Generate(ChainInfo info)
    {
    ...
    private static void AppendStep(StringBuilder sb, StepDef step, string indent)
    {
    ...
    private sealed record ChainInfo(string ClassName, List<CallInfo> Calls);
