...
/// This fixture should be attached to a collection that other collections depend on via <see cref="CollectionChainAwaitFixture{T}"/>.
/// </remarks>
public class CollectionChainSignalFixture<T> : IDisposable
{
    /// <summary>
